...
var TouchRipple = React72.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const startTimer = React72.useRef(null);
  ...
  const start2 = React72.useCallback((event = {}, options = {}, cb) => {
    const {
...
var ButtonBase = React73.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  const rippleRef = React73.useRef(null);
  ...
  const keydownRef = React73.useRef(false);
